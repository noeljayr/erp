<template>
  <div class="grid grid-rows-[auto_1fr] relative overflow-hidden h-full gap-4">
    ...
    <div
      ...
      class="grid grid-cols-1 hide-scrollbar rounded-[var(--radius)] gap-2 h-full overflow-y-auto"
    >
